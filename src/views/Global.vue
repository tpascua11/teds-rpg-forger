          ...
          <table class="table " style="width: 100%; table-layout: fixed;">
            ...
            >
              <tr class="thin-table-row" v-for="(item, index) in globalList" :key="index"
                ...
                v-bind:style="[ globalMatch(item) ? styleSelected : {}]"
              >
...
export default {
  ...
  data: function() {
    return {
      ...
      globalList: this.$root.world.globalEventList,
      showCondition: true,
      selectedArea: {},
      rememberName: '',
    };
  ...
  methods:{
    ...
    createNewGlobalEventEmpty(){
      ...
      this.globalList.push(this.selectedGlobalEvent);
    },
    globalMatch(target){
    ...
    saveAreaInteractionListPosition(){
      this.$root.world.globalEventList = this.globalList;
    },
    //----------
    popShowCondition(){
